...
export type DeliveryInput = { cart: { deliveryGroups: Array<{ id: string }> }, discount: { discountClasses: Array<DiscountClass> } };

export type CartInputVariables = Exact<{ [key: string]: never; }>;


export type CartInput = { cart: { attribute: { value: string | null } | null, lines: Array<{ id: string, cost: { subtotalAmount: { amount: unknown } } }> }, discount: { discountClasses: Array<DiscountClass>, metafield: { jsonValue: unknown } | null } };
